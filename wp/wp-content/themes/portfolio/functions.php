...
function portfolio_scripts() {
  ...
  // フロントページのみ読み込むスクリプト
  if ( is_front_page() ) {
    wp_enqueue_script( 'portfolio-front-script', get_template_directory_uri() . '/js/front.js', array('jquery'), _S_VERSION, true ); 
  } 

  // 自作jQueryファイルの読み込み
  wp_enqueue_script( 'portfolio-script', get_template_directory_uri() . '/js/script.js', array('jquery'), _S_VERSION, true );
